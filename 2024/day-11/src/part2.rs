...
pub fn process(puzzle: Puzzle) -> usize {
    ...
    puzzle.depth_first(75, move |stone, steps| {
...
#[must_use]
#[allow(clippy::needless_pass_by_value)]
pub fn process_breadth_first(puzzle: Puzzle) -> usize {
    puzzle.breadth_first(75)
}
